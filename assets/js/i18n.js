...
const TRANSLATIONS = {
    ...
    portal: {
        ...
        bn: {
            ...
            statusPresent: "উপস্থিত", statusAbsent: "অনুপস্থিত",
    ...
    admin: {
        en: {
            ...
            attendanceDesc: "Today's daily routines — click a class to mark attendance by batch.",
            ...
            ledgerDesc: "Confirm which dates classes were actually held — only confirmed dates appear in student resource filters.",
            ledgerColDate: "Date",
        ...
        bn: {
            ...
            classesToday: "টি ক্লাস আজ",
            noClassesToday: "আজকের কোনো ডেইলি রুটিন নির্ধারিত নেই।",
            markAttendanceBtn: "হাজিরা দিন",
            batchLabel: "ব্যাচ",
            markedCount: "জনের হাজিরা",
            statusPresent: "উপস্থিত",
            statusAbsent: "অনুপস্থিত",
            allPresent: "সবাই উপস্থিত",
            allAbsent: "সবাই অনুপস্থিত",
            saveAttendance: "হাজিরা সংরক্ষণ",
            attendanceSaved: "হাজিরা সফলভাবে সংরক্ষিত হয়েছে!",
            noStudentsInBatch: "এই ব্যাচে কোনো শিক্ষার্থী নিবন্ধিত নেই।",
            todayClassesLabel: "আজকের ক্লাসসমূহ",
            loadingRoutines: "রুটিন লোড হচ্ছে...",
            loadingReport: "রিপোর্ট লোড হচ্ছে...",
            attendanceDesc: "আজকের ডেইলি রুটিন — ব্যাচ অনুযায়ী হাজিরা দিতে একটি ক্লাসে ক্লিক করুন।",
            studentIdCol: "স্টুডেন্ট আইডি",
            nameCol: "নাম",
            statusCol: "অবস্থা",
            attendanceReport: "উপস্থিতি রিপোর্ট",
            noAttendanceRecords: "এখনো কোনো উপস্থিতি রেকর্ড নেই।",
            attendanceSummaryLabel: "সারাংশ:",
            presentCount: "উপস্থিত",
            absentCount: "অনুপস্থিত",
            noAttendanceData: "কোনো হাজিরার ডেটা নেই।",
            attendanceCol: "হাজিরা",
            percentCol: "%",
            refreshBtn: "রিফ্রেশ",
            ...
            // Routine Date Ledger
            ledgerTitle: "রুটিন ডেট লেজার",
            ledgerDesc: "কোন তারিখে ক্লাস হয়েছে তা নিশ্চিত করুন — শুধু নিশ্চিতকৃত তারিখই স্টুডেন্ট রিসোর্স ফিল্টারে দেখা যাবে।",
            ledgerColDate: "তারিখ",
            ledgerColCourse: "কোড",
            ledgerColSubject: "বিষয়",
            ledgerColBatch: "ব্যাচ",
            ledgerColHeld: "ক্লাস?",
            ledgerColConfirmed: "নিশ্চিতকারী",
            ledgerConfirmAll: "সকল দৃশ্যমান কনফার্ম করুন",
            ledgerNoEntries: "এখনো কোনো রুটিন ডেট সিঙ্ক হয়নি। ডেইলি রুটিন তৈরি করলে স্বয়ংক্রিয়ভাবে এখানে যোগ হবে।",
            ledgerToggled: "লেজার আপডেট হয়েছে।",
