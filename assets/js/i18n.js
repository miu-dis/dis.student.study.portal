...
const TRANSLATIONS = {
    ...
    admin: {
        en: {
            ...
            // Forum moderation
            forumTitle: "Discussion Forum Moderation",
            noForumThreads: "No discussion threads found.",
            pinThread: "Pin", unpinThread: "Unpin",
            lockThread: "Lock", unlockThread: "Unlock",
            deleteThread: "Delete", deleteReply: "Delete Reply",
            forumAlertPinned: "Thread pinned.", forumAlertUnpinned: "Thread unpinned.",
            forumAlertLocked: "Thread locked.", forumAlertUnlocked: "Thread unlocked.",
            forumAlertThreadDeleted: "Thread deleted.", forumAlertReplyDeleted: "Reply deleted.",
            confirmDeleteThread: "Delete this thread and all replies?",
            confirmDeleteReply: "Delete this reply?",
            forumJustNow: "just now", forumMinutesAgo: "min ago", forumHoursAgo: "hr ago", forumDaysAgo: "days ago",
            forumBy: "by", forumReplies: "replies",
            forumFilterCourse: "Filter by Course", forumFilterDate: "Filter by Date",
            forumAllCourses: "All Courses", forumAllDates: "All Dates",
            forumNoReplies: "No replies yet.", forumNoDate: "No date",
            forumPinned: "Pinned", forumLocked: "Locked", forumLockedNotice: "Thread is locked. No new replies allowed.",
            forumSubmitReply: "Reply", forumReplyPH: "Write a reply...",
            forumSubmitThread: "Post Thread", forumThreadTitlePH: "Thread title", forumThreadContentPH: "Write your discussion...",
            forumNewThread: "New Thread", forumNoThreads: "No threads yet.",
            forumAlertThreadPosted: "Thread posted!", alertThreadPostFailed: "Failed to post thread.",
            loadingCourses: "Loading...", btnDelete: "Delete",
            valForumTitleRequired: "Title is required.", valForumContentRequired: "Content is required.",
            valForumReplyRequired: "Reply cannot be empty.",
        },
        bn: {
            ...
            forumJustNow: "এই মাত্র", forumMinutesAgo: "মিনিট আগে", forumHoursAgo: "ঘন্টা আগে", forumDaysAgo: "দিন আগে",
            forumBy: "লেখক", forumReplies: "উত্তর",
            forumFilterCourse: "কোর্স অনুযায়ী ফিল্টার", forumFilterDate: "তারিখ অনুযায়ী ফিল্টার",
            forumAllCourses: "সব কোর্স", forumAllDates: "সব তারিখ",
            forumNoReplies: "এখনো কোন উত্তর নেই", forumNoDate: "কোন তারিখ নেই",
            forumPinned: "পিন করা", forumLocked: "লক করা", forumLockedNotice: "থ্রেড লক করা আছে। নতুন উত্তর দেওয়া যাবে না।",
            forumSubmitReply: "উত্তর দিন", forumReplyPH: "একটি উত্তর লিখুন...",
            forumSubmitThread: "থ্রেড পোস্ট করুন", forumThreadTitlePH: "থ্রেডের শিরোনাম", forumThreadContentPH: "আপনার আলোচনা লিখুন...",
            forumNewThread: "নতুন থ্রেড", forumNoThreads: "এখনো কোন থ্রেড নেই",
            forumAlertThreadPosted: "থ্রেড পোস্ট করা হয়েছে!", alertThreadPostFailed: "থ্রেড পোস্ট ব্যর্থ",
            loadingCourses: "লোড হচ্ছে...", btnDelete: "মুছুন",
            valForumTitleRequired: "শিরোনাম প্রয়োজন", valForumContentRequired: "বিষয়বস্তু প্রয়োজন",
